...
Merlin localizes the strings it controls — the auto-injected unsubscribe footer on marketing emails, the hosted unsubscribe / subscribe / preferences pages — into the language of your audience. Your own template content (subject lines, body copy) is **not** translated automatically; you control that yourself.
...
If the contact's `locale` doesn't match a supported language, Merlin falls back to the project default. If neither is set, English is used.
...
Merlin doesn't translate the content of your templates. Two common patterns:
