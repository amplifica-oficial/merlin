---
title: Billing
description: How Merlin's pricing, limits, and consumption work
icon: CreditCard
---

Merlin's pricing is based on the number of emails sent each month. Marketing emails, transactional emails, workflow sends, and inbound emails are all counted under the same monthly usage. Pricing on this page applies to the hosted version at [useplunk.com](https://www.useplunk.com); self-hosted instances run on their own infrastructure.

## Plans

### Free tier

Free tier projects can send up to 1,000 emails per month at no cost. Free-tier projects include a Merlin-branded footer in marketing emails. Inbound emails count toward the 1,000-email allowance.
...
<Cards>
  ...
  <Card title="Self-hosting" href="/self-hosting/introduction">
    Run Merlin on your own infrastructure for full control over costs.
  </Card>
</Cards>
