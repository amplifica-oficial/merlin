...
<Callout title="Attribution" type="info">
  This project is a modified version of [Plunk](https://github.com/useplunk/plunk)
  ([useplunk.com](https://www.useplunk.com/)), licensed under the AGPL-3.0 License.
  Modifications are copyright (C) Amplifica Soluções Digitais LTDA. See the repository
  [NOTICE](https://github.com/amplifica-oficial/merlin/blob/next/NOTICE) for copyright
  attribution details.
</Callout>

## What is Merlin?

Merlin is an open-source email platform designed for developers who need a powerful, scalable solution for transactional and marketing emails. Built to handle millions of contacts, it provides everything you need to manage your email communications — sending, automation, segmentation, deliverability, and analytics.
...
<Cards>
  ...
  <Card title="Files" href="/concepts/files">
    Upload and organize project media, then copy a public URL into templates or campaigns
  </Card>
  ...
  <Card title="Billing" href="/concepts/billing">
    Understand Merlin's billing model and pricing
  </Card>
</Cards>
...
<Cards>
  ...
  <Card title="Self-Hosting" href="/self-hosting/introduction">
    Deploy Merlin on your own infrastructure
  </Card>
...
Merlin is fully open-source and available on GitHub. Contributions are welcome!
