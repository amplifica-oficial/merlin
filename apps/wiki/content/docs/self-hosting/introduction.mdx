---
title: Self-Hosting
description: Deploy Merlin on your own infrastructure
---
...
1. Download the [docker-compose.yml](https://raw.githubusercontent.com/amplifica-oficial/merlin/next/docker-compose.yml)
