...
1. Download [docker-compose.yml](https://raw.githubusercontent.com/amplifica-oficial/merlin/next/docker-compose.yml)
...
| Service | Purpose |
|---------|---------|
| `merlin` | All apps + nginx (API, Web, Wiki) |
...
| Port  | Service                                  |
| ----- | ---------------------------------------- |
| 80    | Nginx (HTTP) — fronts API, dashboard, wiki |
